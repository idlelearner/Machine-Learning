function [ teEr, teSD, trEr, trSD ] = diagFisher( filename, numCrossval )
% Classification of Fisher linear discriminant using within class covariance
% between class calculated from the data given
...
for i = 1 : numCrossval
    ...
    % within c co-variance Identity matrix
    sW = eye(size((xT(1) - meanTr)' * (xT(1) - meanTr)));
